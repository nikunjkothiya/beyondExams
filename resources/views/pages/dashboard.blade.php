				...
				<div class="col-md-9">
					<div class="material_card-stack">
						...
						<ul class="material_card-list">
							<li class="material_card" style="background-color: #fff;">1</li>
							<li class="material_card" style="background-color: #fff;">2</li>		
							<li class="material_card" style="background-color: #fff;">3</li>
						</ul>	
