			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="list-group">
					  	<a href="{{ url('dashboard') }}" class="list-group-item list-group-item-action active d-flex justify-content-between align-items-center">
				...
				<div class="col-md-9">
					<div class="material_card-stack">
									...
									<div class="card" id="{{$opportunity->id}}">
											...
											<div class="col-md-8">
												<div class="title">
													...
													@if(\Auth::user()->saved_opportunities->contains($opportunity->id))
														<div class="col-auto">
															<div class="save">
																<a href="#" value="{{ $opportunity->id }}" title="Save" id="save" class="save-btn"><i id="saveico" class="fa fa-star"></i></a>
															</div>
														</div>
													@else
														<div class="col-auto">
															<div class="save">
																<a href="#" value="{{ $opportunity->id }}" title="Save" id="save" class="save-btn"><i id="saveico" class="fa fa-star-o"></i></a>
															</div>
														</div>
													@endif
												</div>
										...
										<div class="row">
											...
											<div class="col-auto ml-auto">
												<a href="mailto:?Subject={{$opportunity->title}}&amp;Body={{$opportunity->description}} {{ url('/opportunity/'.$opportunity->id) }}" class="btn btn share-btn">@lang('opportunity.share')</a>
											</div>
											<div class="col-auto">
												<a href="{{ url('opportunity/'.$opportunity->slug) }}" target="_blank" class="btn btn apply-btn">@lang('dashboard.readmore')</a>
											</div>
										</div>
									</div>
						...
						<button class="material_buttons material_next" id="next"><i class="fa fa-arrow-down"></i></button>
					</div>
				</div>
			</div>
		</div>
			    ...
			    success: function(response) {
			    	...
			    	if(response.data.length){
				    	...
				    	if(user_opps.includes(res.id)){
				    		save = '<div class="col-auto"><div class="save"><a href="#" value="'+res.id+'" title="Save" id="save" class="save-btn"><i id="saveico" class="fa fa-star"></i></a></div></div>';
				    	}
				    	else{
